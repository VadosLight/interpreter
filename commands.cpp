/*
 	 Commands.cpp 
   ћодуль, отвечающий за вычисление выражений.
   ѕарсер ыражени€ подаЄтс€ в функцию evaluate_expression.
   ¬се промежуточные вычислени€ и результаты в формате float.
  
   ќсобые ситуации:
       ¬ случае возникновени€ ошибок выбрасываютс€ исключени€ типа 
   const char *
 */ 
